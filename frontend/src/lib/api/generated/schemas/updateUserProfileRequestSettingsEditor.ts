 ...
 */
export type UpdateUserProfileRequestSettingsEditor = typeof UpdateUserProfileRequestSettingsEditor[keyof typeof UpdateUserProfileRequestSettingsEditor];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateUserProfileRequestSettingsEditor = {
  rich: 'rich',
  markdown: 'markdown',
  split: 'split',
} as const;
