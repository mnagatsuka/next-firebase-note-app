 ...
 */
export type UpdateUserProfileRequestSettingsTheme = typeof UpdateUserProfileRequestSettingsTheme[keyof typeof UpdateUserProfileRequestSettingsTheme];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateUserProfileRequestSettingsTheme = {
  light: 'light',
  dark: 'dark',
  system: 'system',
} as const;
